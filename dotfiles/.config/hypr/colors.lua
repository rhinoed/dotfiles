...
on_tertiary_fixed_variant = "rgba(5e3c52ff)"
...
primary_container = "rgba(3d4278ff)"
...
tertiary = "rgba(e8b9d5ff)"

tertiary_container = "rgba(5e3c52ff)"

tertiary_fixed = "rgba(ffd8eeff)"

tertiary_fixed_dim = "rgba(e8b9d5ff)"
